...
"""
# It would have been helpful to me for the instructions to stop the process to specify that you need to click inside the terminal before pressing Ctrl + C
...
for row in reader:
    ...
    fstring_message = f"[{id}, {vendor_id}, {pickup_datetime}, {dropoff_datetime}, {passenger_count}]"
